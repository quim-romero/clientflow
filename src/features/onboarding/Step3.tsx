export default function Step3() {
  return (
    <section className="container py-12 max-w-xl">
      ...
      <div className="cursor-pointer border-2 border-dashed border-muted/50 dark:border-white/20 rounded-xl p-6 text-center hover:bg-muted/10 dark:hover:bg-white/5 transition">
